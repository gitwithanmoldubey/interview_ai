...
const Home = () => {
    ...
    if (loading) {
        return <LoadingScreen message="Creating your custom interview strategy..." />
    }
    ...
    return (
        <div className='home-page'>
            ...
            <div className='interview-card'>
                {errorMessage && (
                    <div style={{ color: '#ef4444', padding: '12px 24px', backgroundColor: 'rgba(239, 68, 68, 0.1)', borderRadius: '8px', margin: '16px 24px 0 24px', fontWeight: '500' }}>
                        ⚠️ {errorMessage}
                    </div>
                )}
                <div className='interview-card__body'>
                    ...
                    <div className='panel panel--left'>
                        ...
                        <textarea
                            onChange={(e) => { setJobDescription(e.target.value); setErrorMessage(""); }}
                    ...
                    <div className='panel panel--right'>
                        ...
                        <div className='upload-section'>
                            ...
                            <label className='dropzone' htmlFor='resume' style={selectedFileName ? { borderColor: '#10b981', backgroundColor: 'rgba(16, 185, 129, 0.05)' } : {}}>
                                ...
                                {selectedFileName ? (
                                    <>
                                        <p className='dropzone__title' style={{ color: '#10b981' }}>📄 {selectedFileName}</p>
